...
import 'package:myapp_week5/home/homepage.dart';
import 'package:myapp_week5/register/register_page.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  _login(acc) async {
    var urlLogin = Uri.http('host_name', '/api/login');
    ...
    if (response.statusCode == 200) {
      ...
      if (res['status'] == 'ok') {
        storage.setItem('user-key', jsonDecode(response.body));
        Navigator.push(
